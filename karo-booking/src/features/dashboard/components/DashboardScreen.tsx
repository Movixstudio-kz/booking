...
export function DashboardScreen() {
  const { appointments, activeStaff, activeServices, todayAppointments, freeSlots } = useDashboardData();
  const metrics = [
