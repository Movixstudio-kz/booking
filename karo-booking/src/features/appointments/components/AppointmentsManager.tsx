...
export function AppointmentsManager() {
  ...
  function updateStatus(appointment: BookingRecord, status: BookingStatus) {
    if (!canChangeAppointmentStatus(currentUser, appointment)) {
      setMessage(deniedMessage);
      return;
    }
    if (!changeAppointmentStatus(appointment.id, status)) {
